...
class BrachyCT(torch.utils.data.Dataset):
    def __init__(self, a_dir="data/brachy_ct/train/artifact", b_dir="data/brachy_ct/train/no_artifact",
        random_flip=False, a_range=(-1000.0, 2000.0), b_range=(-1000.0, 2000.0)):
        super(BrachyCT, self).__init__()
